...
from users_management.views import profile, UpdatePassword, DeleteAccount, UpdateAccountDetails, ManageAccounts, ArchiveAccounts, AddAccount, EditAccount, ViewAccount, ArchieveUserAccount, RestoreUserAccount, AddUserAccount
